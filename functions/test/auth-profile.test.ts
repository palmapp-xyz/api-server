...
describe('API Testing', () => {
  ...
  describe('Profile APIs', () => {
    ...
    it('should fetch user profile', async () => {
      ...
      // eslint-disable-next-line no-unreachable
      const response = await Axios.get('https://asia-northeast3-oedi-a1953.cloudfunctions.net/v1/profile/get/' + id);
      // eslint-disable-next-line no-console
      console.log(response.data);
      // eslint-disable-next-line no-undef,no-unused-expressions
    ...
    it('should update user profile', async () => {
      ...
      // eslint-disable-next-line no-unreachable
      const response = await Axios.put('https://asia-northeast3-oedi-a1953.cloudfunctions.net/v1/profile/update',
          {
            nft_tokenId: '200'
          },
          {
    ...
    it('should fetch user\'s sendbird_token', async () => {
      ...
      const id = '0x1Efd3eFd7c78d98B155F724EB6A161C50d8CFbf0'
      // eslint-disable-next-line no-unreachable
      const response = await Axios.get('https://asia-northeast3-oedi-a1953.cloudfunctions.net/v1/profile/sendbird_token',
          {
            headers: {
              'Authorization': `Bearer ${JWT}`
            }
    ...
    it('should delete user profile', async () => {
      ...
      // eslint-disable-next-line no-unreachable
      const response = await Axios.delete('https://asia-northeast3-oedi-a1953.cloudfunctions.net/v1/profile/delete',
          {
            headers: {
              'Authorization': `Bearer ${JWT}`
            }
