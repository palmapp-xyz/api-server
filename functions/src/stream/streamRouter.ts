 ...
 * @param {string} id.query.required - Stream ID to be updated
 * @return {object} 200 - Stream object
 * @security JWT
 *
 */
 ...
 * @tags Stream
 * @param {string} id.query.required - Stream ID to be deleted
 * @return {object} 200 - Stream object
 *
 */
 ...
 * @tags Stream
 * @param {string} id.query.required - Stream ID where address is to be added
 ...
 * @tags Stream
 * @param {string} id.query.required - Stream ID where address is to be removed
 ...
 * @tags Stream
 * @param {string} id.query.required - Stream ID where addresses are to be fetched
 * @return {object} 200 - Stream object
 *
 */
