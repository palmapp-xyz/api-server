...
const config = {
  ...
  ELASTIC_SEARCH_PROFILE_INDEX_NAME_TESTNET: readEnv('ELASTIC_SEARCH_PROFILE_INDEX_NAME_TESTNET'),
  ELASTIC_SEARCH_CHANNEL_INDEX_NAME_TESTNET: readEnv('ELASTIC_SEARCH_CHANNEL_INDEX_NAME_TESTNET'),
  ELASTIC_SEARCH_PROFILE_INDEX_NAME_MAINNET: readEnv('ELASTIC_SEARCH_PROFILE_INDEX_NAME_MAINNET'),
  ELASTIC_SEARCH_CHANNEL_INDEX_NAME_MAINNET: readEnv('ELASTIC_SEARCH_CHANNEL_INDEX_NAME_MAINNET'),
  ...
  INDEXERS_NETWORK: readEnv('INDEXERS_NETWORK'),
