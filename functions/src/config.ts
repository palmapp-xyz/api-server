...
const config = {
  ...
  SENDBIRD_APP_ID_TESTNET: readEnv('SENDBIRD_APP_ID_TESTNET'),
  SENDBIRD_API_TOKEN_TESTNET: readEnv('SENDBIRD_API_TOKEN_TESTNET'),
  SENDBIRD_API_URL_TESTNET: readEnv('SENDBIRD_API_URL_TESTNET'),

  SENDBIRD_APP_ID_MAINNET: readEnv('SENDBIRD_APP_ID_MAINNET'),
  SENDBIRD_API_TOKEN_MAINNET: readEnv('SENDBIRD_API_TOKEN_MAINNET'),
  SENDBIRD_API_URL_MAINNET: readEnv('SENDBIRD_API_URL_MAINNET'),
